...
namespace XLib.Animate
{
    public static class AnimationHelper
    {
        ...
        /// 创建动画
        /// </summary>
        public static Animation CreateAnimation(this IMotion source, string property, double begin, double end,
            double duration,
            EasingType type = EasingType.LinearEase, EasingMode mode = EasingMode.EaseIn, double delay = 0,
            double wait = 0, bool loop = false)
        {
